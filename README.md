# Dev platform — Gitea + Drone CI + Harbor
...
**Integrates with:** g-oss-helm modules, g-oss-platform meta repos.
    ...
    - Helm chart skeleton is under `charts/g-oss-devops` (namespace defaults to `platform`).
    ...
    - For Helm, set values in `charts/g-oss-devops/values.yaml`.
